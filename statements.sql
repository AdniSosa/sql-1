...
-- Tu respuesta aquí
SELECT lenguaje, CHAR_LENGTH(lenguaje) AS longest_language FROM usuarios_lenguajes ORDER BY longest_language DESC LIMIT 1;
...
-- Tu respuesta aquí
SELECT COUNT(*), edad FROM usuarios_lenguajes GROUP BY edad HAVING COUNT(edad) > 1; --No logré que me sacara los nombres de los que se repetía.

-- Ejercicio 26: Encontrar el usuario con el lenguaje con mayor número de carácteres y que tenga una edad menor de 30 años. 
-- Tu respuesta aquí
SELECT nombre, apellido, lenguaje, CHAR_LENGTH(lenguaje) AS longest_language FROM usuarios_lenguajes WHERE edad < 30  ORDER BY longest_language DESC LIMIT 1;
...
-- Tu respuesta aquí
SELECT *, CHAR_LENGTH(lenguaje) AS less_characters FROM usuarios_lenguajes WHERE lenguaje LIKE 'j%' ORDER BY less_characters ASC LIMIT 1;

-- Ejercicio 30: Encontrar el usuario con edad mayor a 30 y que sabe el lenguaje con menos caracteres.
-- Tu respuesta aquí
SELECT *, CHAR_LENGTH(lenguaje) AS less_characters FROM usuarios_lenguajes WHERE edad > 30 ORDER BY less_characters ASC LIMIT 1;
...
-- Tu respuesta aquí
SELECT nombre, apellido FROM usuarios_lenguajes WHERE lenguaje <> 'sql';

-- Ejercicio 34: Encontrar el lenguaje con más caracteres entre los usuarios que tienen al menos 30 años.
-- Tu respuesta aquí
SELECT lenguaje, CHAR_LENGTH(lenguaje) AS longest_language FROM usuarios_lenguajes WHERE edad >= 30 ORDER BY longest_language DESC LIMIT 1;
...
-- Tu respuesta aquí
SELECT nombre, apellido, CHAR_LENGTH(nombre) AS longitud_nombre FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;
...
-- Tu respuesta aquí
SELECT SUM(edad) AS suma FROM usuarios_lenguajes; --Solo muestra la suma
